...
NORD_TMUX_COLOR_THEME_FILE=nord-general.conf
NORD_TMUX_VERSION=0.3.0
NORD_TMUX_STATUS_CONTENT_FILE="nord-status.conf"
NORD_TMUX_STATUS_CONTENT_NO_PATCHED_FONT_FILE="nord-sunpatched.conf"
